  ...
  return (
    <main className="min-h-screen font-sans text-cream-light selection:bg-sunset selection:text-white relative flex flex-col overflow-x-hidden pb-12">
      ...
      {/* =========================================================
          ...
          ========================================================= */}
      <div className="absolute top-4 right-4 z- flex md:hidden items-center gap-3">
      ...
      {isMobileMenuOpen && (
        <div 
          className="fixed inset-0 z- bg-black/20 backdrop-blur-sm md:hidden"
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 flex-grow flex flex-col justify-center">
        ...
        <div className="relative w-full rounded-[2.5rem] bg-black/20 backdrop-blur-xl border border-white/15 shadow-2xl overflow-hidden p-8 md:p-12 lg:p-16">
          ...
          <div className={`transition-all duration-500 transform ${isAnimating ? 'opacity-0 scale-[0.98]' : 'opacity-100 scale-100'} flex flex-col lg:flex-row gap-12 lg:gap-20 items-center`}>
            ...
            <div className={`flex-1 flex flex-col w-full ${current.reviewImage ? 'text-left' : 'text-center items-center mx-auto max-w-4xl'}`}>
              ...
              <div className={`flex items-center gap-5 mt-auto ${current.reviewImage ? '' : 'justify-center'}`}>
                ...
                <div className={current.reviewImage ? 'text-left' : 'text-left'}>
                  ...
                  <div className="font-sans text-sunset-light text-xs md:text-sm font-medium tracking-wide text-white uppercase">
            ...
            {/* UPDATED: Right Side Image Frame to prevent cropping */}
            {current.reviewImage && (
              <div className="w-full lg:w-2/5 flex-shrink-0">
                <div className="relative rounded-[2rem] overflow-hidden bg-white/5 border border-white/20 shadow-2xl p-2 flex items-center justify-center backdrop-blur-md">
                  <img 
                    ...
                    alt="Ceremony Moment" 
                    // max-h-[50vh] prevents it from breaking layout heights, object-contain stops cropping
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 px-2">
            ...
            <div className="flex items-center gap-4">
              <button onClick={handlePrev} className="flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/5 hover:bg-white/10 border border-white/15 text-white shadow-md transition-all duration-300 hover:-translate-x-1">
              ...
              <button onClick={handleNext} className="flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/5 hover:bg-white/10 border border-white/15 text-white shadow-md transition-all duration-300 hover:translate-x-1">
